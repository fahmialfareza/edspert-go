...
func (repo *albumRepository) GetAlbumCache(id int64) (*entity.Album, error) {
	return repo.cache.GetAlbum(id)
}
...
func (repo *albumRepository) SetAlbumCache(id int64, album entity.Album) error {
	return repo.cache.SetAlbum(id, album)
}
...
func (repo *albumRepository) DeleteAlbumCache(id int64) error {
	return repo.cache.Delete(id)
}
